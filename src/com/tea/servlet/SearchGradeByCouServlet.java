...
/**
 * Servlet implementation class SearchGradeByCouServlet
 */
@WebServlet("/SearchGradeByCouServlet")
public class SearchGradeByCouServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<OrderCourseInfo> list = teacherService.teaFindGradeByCou(teaNum, couNum, term, year);
