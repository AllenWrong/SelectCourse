...
/**
 * Servlet implementation class DeleteTermPlanServlet
 */
@WebServlet("/DeleteTermPlanServlet")
public class DeleteTermPlanServlet extends HttpServlet {
...
//			String tpCourName = jsonObject.getString("courName");
			...
			JsonTool.justExec(mngService.doDeletTermPlan(termPlanInfo),response);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
