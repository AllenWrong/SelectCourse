...
/**
 * Servlet implementation class SearchCanSelCouSerlvet
 */
@WebServlet("/SearchCanSelCouSerlvet")
public class SearchCanSelCouSerlvet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<OrderCourseInfo> list = studentService.viewCourseCanSelect(year, term, grade);
