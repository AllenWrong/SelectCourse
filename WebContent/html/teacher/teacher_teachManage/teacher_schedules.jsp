...
<html>
    <head>
        ...
        <script type="text/javascript" src="/SelectCourse/js/schdtool.js"></script>
    </head>
    <body>
    ...
    <script>
   	...
   	<c:forEach var="obj" items="${sessionScope.teaSchdl }" begin="0" end="${fn:length(sessionScope.teaSchdl) }" step="1">
		<script type="text/javascript">
       		var name = '${obj.ordCouCouNum}';
       		var time = formatTime("${obj.ordCouTeaTime}");
       		var teaName = "${obj.ordCouTeaNum}";
       		var place = "${obj.ordCouTeaPlace}";
       		var startend = "${obj.ordCouQzz}"
       		var res = name+"<br/>"+time+"<br/>"+teaName+"<br/>"+place+"{"+startend+"周"+"}";
       		
			document.getElementById("${obj.ordCouTeaTime}").innerHTML= res;
		</script>	
	</c:forEach>
    </body>
</html>